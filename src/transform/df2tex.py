...
if __name__ == '__main__':
    ...
    print df_test
    df_test_split = pd.DataFrame(df_test['value'].values.tolist(), columns=['team1','team2'])
    df_test_split['variable'] = dic0.keys()
    print df_test_split
    print '----------------------'
    df2tex(df_test_split, '/Users/yuwang/Documents/research/research/lawschool/data/edit/','test_df2tex.tex', "%8.2f", 0, ['team1','team2'], ['variable'], ['team1','team2'])
